defmodule StylerBooBooWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(StylerBooBooWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(StylerBooBooWeb.Gettext, "errors", msg, opts)
    # end
